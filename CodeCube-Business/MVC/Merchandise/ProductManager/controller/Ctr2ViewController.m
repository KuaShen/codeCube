...
@interface Ctr2ViewController ()

@property (nonatomic, strong) AddOnItemsTableViewController *vc1;

@end

@implementation Ctr2ViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    
    
     _vc1 = [[AddOnItemsTableViewController alloc] init];
    ...
    .bottomEqualToView(selectAllBtn)
    .rightEqualToView(self.view);
    [cancelSaleBtn setTitle:@"取消拼单" forState:UIControlStateNormal];
    ...
    [startSaleBtn setTitle:@"发起拼单" forState:UIControlStateNormal];
